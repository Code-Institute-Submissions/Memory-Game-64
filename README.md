...
As soon as you enter the display page you can easily see within the navbar the 'Memory Game' section, upon clicking on the start game button,this will taken you to a section filled with cards with question marks that you can click on to flip the cards.
